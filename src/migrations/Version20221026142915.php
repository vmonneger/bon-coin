 ...
 */
final class Version20221026142915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE announces CHANGE images images VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE announces CHANGE images images LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }
}
