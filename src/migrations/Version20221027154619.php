 ...
 */
final class Version20221027154619 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE announces DROP tags, CHANGE images images VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE announces ADD tags LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE images images LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }
}
